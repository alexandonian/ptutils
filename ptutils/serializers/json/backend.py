...
class YAMLBackend(object):
    ...
    def load_backend(self, name,
                     dumps='dump', loads='load', loads_exc=ValueError):
        """Load a YAML backend by name.
    ...
    def encode(self, obj):
        """
        Attempt to encode an object into YAML.
    ...
    def decode(self, string):
        """
        Attempt to decode an object from a YAML string.
    ...
    def set_preferred_backend(self, name):
        """
        Set the preferred yaml backend.
